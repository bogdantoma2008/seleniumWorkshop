...
public class Homework extends BaseTest {
	...
	public void script(String name, String email, String subject, String message) {
		...
		WebElement buttonSendMessage = driver.findElement(By.xpath("//input[@type='submit' and contains(@class, 'wpcf7')]"));
		...
		sa.assertTrue(confirmationField.getText().equals(messageSentConfirmation));
